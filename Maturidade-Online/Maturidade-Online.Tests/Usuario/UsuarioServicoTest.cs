...
namespace Maturidade_Online.Tests
{
    ...
    public class UsuarioServicoTest
    {
        ...
        public void UsuarioBuscarPorAutenticacao()
        {
            ...
            A.CallTo(() => repositorio.BuscarPorEmail(usuario)).Returns(new Usuario {Email = "teste@cwi.com.br", Senha = "698dc19d489c4e4db73e28a713eab07b" } );
        ...
        public void UsuarioBuscarPorEmail()
        {
            ...
            A.CallTo(() => repositorio.BuscarPorEmail(usuario)).Returns(new Usuario { Email = "teste@cwi.com.br" });
